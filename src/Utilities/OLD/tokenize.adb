package body Tokenize is
   ...
   begin
      ...
      while Current <= To_Be_Splitted'Last loop
         ...
         String_Vectors.Append (Result, To_Be_Splitted (First .. Current - 1));
   ...
   is
      ...
      Dst : Token_List;
   begin
      Src.Append (To_Be_Splitted);

      for Sep of Separators loop
         Dst.Clear;

         for Input of Src loop
            Dst.Append (Split (Input, Sep, Collate_Separator));
         end loop;
